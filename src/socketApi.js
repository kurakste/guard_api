...
const cpEventEmitter = require('./common/socketEventEmitters/cpEventEmitters');
const appEventEmitter = require('./common/socketEventEmitters/appEventEmitters');
...
cpIOBus.on('connection', async (socket) => {
  ...
  const cpPickedUpAlarm = cpSocketController.cpPickedUpAlarm
    .bind(cpSocketController, cpIOBus, socket, authResult, connectedAppUsers);
